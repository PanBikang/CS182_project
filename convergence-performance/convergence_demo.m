...
run_PPM = 1; run_MGD = 1; run_GPM = 1; %%% 1 = run the method; 0 = don't run the method
...
if mu == 5
    ylim([1e-8, 1e4]); title('\mu = 5, \gamma=1'); 
else mu == 10
    ylim([1e-8, 1e4]); title('\mu = 10, \gamma=1');
end
